...
CREATE TABLE "new_branches" (
    ...
    "gps_latitude" REAL,
    "gps_longitude" REAL,
    "gps_radius_km" INTEGER NOT NULL DEFAULT 5,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
INSERT INTO "new_branches" ("code", "created_at", "id", "name", "region") SELECT "code", "created_at", "id", "name", "region" FROM "branches";
DROP TABLE "branches";
...
CREATE TABLE "new_submissions" (
    ...
    "out_of_zone_km" REAL,
    "escalation_alerted_at" DATETIME,
...
INSERT INTO "new_submissions" ("ai_feedback", "ai_raw_response", "campaign_id", "caption", "evaluation_result", "first_reviewed_at", "gps_address", "gps_latitude", "gps_longitude", "id", "image_path", "manual_override", "meets_standard", "overridden_at", "override_reason", "override_user_id", "promotor_id", "quality_fail_reason", "quality_failed", "reported_subscribers", "similarity_score", "submission_type", "submitted_at", "team_leader_id", "vision_cached", "wa_chat_id", "wa_message_id", "wa_sender_name", "wa_sender_number") SELECT "ai_feedback", "ai_raw_response", "campaign_id", "caption", "evaluation_result", "first_reviewed_at", "gps_address", "gps_latitude", "gps_longitude", "id", "image_path", "manual_override", "meets_standard", "overridden_at", "override_reason", "override_user_id", "promotor_id", "quality_fail_reason", "quality_failed", "reported_subscribers", "similarity_score", "submission_type", "submitted_at", "team_leader_id", "vision_cached", "wa_chat_id", "wa_message_id", "wa_sender_name", "wa_sender_number" FROM "submissions";
